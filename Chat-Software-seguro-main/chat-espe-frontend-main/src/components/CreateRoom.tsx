...
import { buildAuthHeaders } from '../services/biometricToken';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!headers.Authorization) {
        alert('Se requiere iniciar sesión con el gateway biométrico.');
        setLoading(false);
        return;
      }

      const res = await axios.post(`${API_BASE_URL}/api/admin/rooms`, form, {
